...
public class Subway {
    ...
    public static int countEntrances(ArrayList<ArrayList<String>> lines, String subwayLine) {
        ...
        while (linesIter.hasNext()) {
            ...
            ArrayList<String> currentEntrance = linesIter.next(); // stores location of current array list which contains a string of a subway entrance location and its subway lines
            int lastItem = currentEntrance.size() - 1; // stores index of the last String in currentEntrance ArrayList

            // first checks if the last String of the current ArrayList contains a single character and compares it to subwayLine and increments counter if it matches
            // otherwise it checks if the last String of the current ArrayList contains subwayLine + space or dash ie: "E-" or "E " or "-E". This excludes the E in the word Express.
            if (currentEntrance.get(lastItem).length() == 1 && currentEntrance.get(lastItem).contains(subwayLine)) {
                count++;
            } else if (currentEntrance.get(lastItem).contains(subwayLine + "-")
                    || currentEntrance.get(lastItem).contains(subwayLine + " ")
                    || currentEntrance.get(lastItem).contains("-" + subwayLine)) {
                count++;
            }
    ...
    public static void main(String[] args) {
        // This creates a 500x300 pixel drawing.
        ...
        File f = new File("/Users/c4q-anthonyf/Desktop/accesscode/AC-20150326/resources/subway-data.txt");
